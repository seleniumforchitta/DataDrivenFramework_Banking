...
public class TestConfig{
	...
	public static String from = "seleniumforchitta@gmail.com";
	public static String password = "bbbbb@123";
	public static String[] to ={"seleniumforchitta@gmail.com","priya.586586@gmail.com"};
